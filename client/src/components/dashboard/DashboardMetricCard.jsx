...
const DashboardMetricCard = ({ title, value, subtitle, icon, accent = 'violet' }) => {
    const styles = ACCENT_STYLES[accent] || ACCENT_STYLES.violet;

    return (
        <div className="bg-white dark:bg-slate-900 p-5 sm:p-6 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-sm group hover:shadow-md transition-all">
